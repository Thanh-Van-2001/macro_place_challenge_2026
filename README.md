...
> challenge. Our placer (`submissions/hybrid_v12_multistart.py`) achieves **AVG 1.2075**
> on the 17 IBM ICCAD04 benchmarks — beating the RePlAce baseline by **17.2%** and
> the SA baseline by **43.1%**, all 17 VALID with 0 overlaps. Estimated leaderboard rank: **#3** (just past KLA MACH 1.2121, gap 0.38%). See [`SUBMISSION.md`](SUBMISSION.md) for full details, the
